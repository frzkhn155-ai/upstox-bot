...
def parse_date_flexible(text):
    """
    Parse a date string like '3/7/2026', '03.07.2026', '3-7-26', etc. into a
    (day, month, year) tuple of ints. Handles '/', '.', '-' separators and
    missing leading zeros, so '3/7/2026' and '03/07/2026' compare as equal.
